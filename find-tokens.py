...
def getGoodCoins(dex, firstPair):
    coins = []
    endPageNumber = None
    pageNumber = 1
    while (True):
        try:
            ...
            for row in result['data']:
                ...
                token1 = getDetail(includedData, 'token', row['relationships']['tokens']['data'][1]['id'])[
                    'attributes']['address']
                if token0 == firstPair:
                    coins.append([token0, token1])
                elif token1 == firstPair:
                    coins.append([token1, token0])
...
coins = getGoodCoins(
    'biswap', "0xe9e7cea3dedca5984780bafc599bd69add087d56") + getGoodCoins(
    'biswap', "0x55d398326f99059ff775485246999027b3197955") + getGoodCoins(
    'biswap', "0x8ac76a51cc950d9822d68b83fe1ad97b32cd580d")
print(str(coins))
